...
保留 c752807 及以前成果，当前仅按 [阶段七](stage-seven.md) 的三个代码缺口和原型退出条件推进，尚未完成本轮验证。网站访问、代理、许可、大附件和历史 partial 数据按 [人工补齐清单](manual-follow-up.md) 交接，不再作为开发前置。以下旧“完成/下一步”均限原阶段和证据范围，不代表新缺口已修复，不触发旧任务重跑。
